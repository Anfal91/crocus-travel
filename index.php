                    ...
                    <nav class="navbar navbar-default navbar-sticky-function navbar-arrow">
                        ...
                        <div id="navbar" class="navbar-nav-wrapper">
                            <ul class="nav navbar-nav" id="responsive-menu">
                                ...
                                <li>
                                    <a href="dotnet.aspx">About <i class="fa fa-angle-down"></i></a>
                                    <ul>
                                        <li>
                                ...
                                <div class="about-location">
                                    <ul>
                                        ...
                                        <li><i class="flaticon-mail"></i> <a href="/cdn-cgi/l/email-protection"
                                                class="__cf_email__"
                                                data-cfemail="bdc9d2c8cfd3c9cfdccbd8d1fdc9d8cec9d0dcd4d193ded2d0">[email&#160;protected]</a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="copyright-content">
                            <p>
                                2023 <i class="fa fa-copyright" aria-hidden="true"></i> crocus travel by <a href="#"
                                    target="_blank">solo developer</a>
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
